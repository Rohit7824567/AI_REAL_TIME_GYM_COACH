...
def main():
    ...
    with st.sidebar:
        ...
        if workout_started:
            ...
            st.metric("current Sets Reps", f"{current_set_reps}/{reps_per_set}")
    ...
    st.markdown("### Real-time pose detection with proactive with proactive AI voice coach")
